...
describe('leaseMonthly — tesla.com golden numbers (pre-tax)', () => {
  ...
  for (const [label, base, residual, expected] of cases) {
    it(`${label} within $4 of $${expected}/mo`, () => {
      const r = leaseMonthly(base + FEES, 5000, 0, residual, APR, TERM, 0);
