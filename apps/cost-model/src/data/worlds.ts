...
export const WORLDS: World[] = [
  ...
  },
  {
    ...
    note: 'YOUR configured car (read off the live configurator 7/4/26, Seattle ZIP): Premium AWD $49,990 + Quicksilver $2,000 + white interior $1,000 + tow hitch $1,000 + $1,390 dest + $250 order = $55,630 pre-tax, × 1.1105 WA vehicle tax (Seattle 10.55% + 0.5% MV) = $61,777 OTD. ⚠ This row charts 0.99% while rolling the Kia shortfall on low cash — the OPTIMISTIC bound. Really keeping 0.99% needs ~5% down of the car + WA tax + the shortfall in CASH (≤~100% LTV) ≈ $10k at a $26k trade; rolling it to stay low-cash pushes >100% LTV and forfeits the promo to the standard 5.64% (the “MY 5.64%” row) — see analyses/model-y-premium-awd-seattle-2026-07.md §4 for the getaways. Upfront carries the $553 roof rack (incl. tax). FSD is subscription-only now (buy-outright ended 2/14/26): $99/mo + WA tax ≈ $109 — toggle above. First registration ≈ $805 (RTA ~$550/yr recurs; +$225/yr EV fees from renewal) sits outside every world, as does the Kia’s own renewal. 0.99%/72 promo verified live 7/4/26 (Premium RWD/AWD; never $0-down — Tesla requires a real down payment, and the dead §30D credit can no longer serve as it). Insurance = your real quote (Progressive $2,500/6 mo ≈ $417/mo; GEICO wanted $500/mo) — editable above. No CarPlay.',
  },
  {
  ...
  },
  {
    ...
    resale: [61777, 46200, 40000, 34900, 30800, 26700, 22600, 18500], owns: true,
    note: 'The ZERO-DOWN / low-cash getaway: Tesla’s standard rate (5.64%/72, live configurator 7/4/26; market prime ~6.2%) with ~$0 down, rolling WA tax + the Kia shortfall into the loan (>100% LTV — which is exactly why the subvented 0.99% does NOT apply here). Costs ~$9.8k more over 72 mo than fronting ~$10k to keep 0.99% — that spread is the price of not putting cash down. 0.99% is purchase-only, so you cannot refinance into it later. Loan-interest deduction assume $0 (phases out $100–150k MAGI single).',
  },
  {
